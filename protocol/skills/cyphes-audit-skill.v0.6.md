...
- `exploitPath` (optional string) is a concise walk of the attack path: who
  calls what, in what order, to reach the bad state. Omit for informational
  findings.
- `filePath` (optional string) is the exact repository-relative path of the
  file being accused (e.g. `contracts/Vault.sol`). Must match a file in the
  supplied context.
- `function` (optional string) is the function name being accused.
- `line` (optional integer) is the line number of the defect.
- `reproductionSteps` (optional array of strings) is a list of concrete steps
  to reproduce on a testnet/fork. Omit when not applicable.
  ...
  "findings": [
    {
      ...
      "line": 214,
      "reproductionSteps": [
        "Deploy Vault with zero supply",
        "Call withdraw() as any depositor",
        "Observe fee accrual skipped"
      ],
      "reportable": false
    }
  ],
